...
namespace EarlyBookingService.WebAPI.Migrations
{
    ...
    [Migration("20190206160605_CorrectRecordsFromPriceDetail")]
    partial class CorrectRecordsFromPriceDetail
    {
            ...
            modelBuilder.Entity("EarlyBookingService.Lib.Models.PriceDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 13, BookingId = 8, Cost = 3000.0, PurchaseCostId = 8 },
                        new { Id = 14, BookingId = 9, Cost = -1125.0, PurchaseCostId = 7 },
                        new { Id = 15, BookingId = 9, Cost = 4500.0, PurchaseCostId = 8 },
                        new { Id = 16, BookingId = 10, Cost = -1875.0, PurchaseCostId = 7 },
                        new { Id = 17, BookingId = 10, Cost = 7500.0, PurchaseCostId = 8 }
                    );
                });
